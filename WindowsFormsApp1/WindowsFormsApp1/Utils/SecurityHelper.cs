 ...
 /// </summary>
         ...
         if (departments == null || departments.Count == 0)
  {
   ...
   StringBuilder csvContent = new StringBuilder();
     ...
     // Add headers
             csvContent.AppendLine("STT,Mã Phòng Ban,Tên Phòng Ban,Trưởng Phòng,Số Nhân Viên,Địa Điểm,Điện Thoại,Email,Trạng Thái");
...
$"{dept.EmployeeCount}," +
  ...
  // Create CSV content
    ...
    csvContent.AppendLine(); // Empty line
          ...
          // Add headers
    csvContent.AppendLine("STT,Mã NV,Họ Tên,Phòng Ban,Ngày,Giờ Vào,Giờ Ra,Số Giờ Làm,Trạng Thái,Ghi Chú");
